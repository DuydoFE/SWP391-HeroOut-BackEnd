...
public class ScheduleService {
    ...
    public List<Schedule> getSchedulesByAccountId(long accountId) {
        return scheduleRepository.findByAccountId(accountId); // Uses the custom method defined in the repository
    }
